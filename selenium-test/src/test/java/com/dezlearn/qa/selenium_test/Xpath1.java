...
public class Xpath1 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@aria-label='Mobile number or email address']")).sendKeys("test@gmail.com");
		
		driver.findElement(By.xpath("//input[@aria-label='Re-enter email address']")).sendKeys("test@gmail.com");
		
		driver.findElement(By.xpath("//input[@aria-label='New password']")).sendKeys("Abc@#$123");//xpath using attribute
